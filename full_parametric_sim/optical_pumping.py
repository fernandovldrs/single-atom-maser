...
#### Attention: this script takes 4 days to simulate with monte-carlo.
...
def run_simulation(sweep_param):
    ...
    result = qutip.mcsolve(H_total, initial_state, t_list, c_ops = c_ops, args = {"sweep_param": sweep_param})
