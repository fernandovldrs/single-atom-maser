...
result = qutip.mcsolve(H, initial_state, t_list, c_ops = c_ops, options=Options(nsteps=4000))
...
# plt.legend()
filename = f'C:\\Users\\admin\\Documents\\single-atom-maser\\final_state_{int(t_sim)}.png'
...
#     t_sim_list = [20]#, 5e3, 10e3, 15e3, 20e3]
#     pool = Pool(processes=1)  # Adjust the number of processes based on your CPU
