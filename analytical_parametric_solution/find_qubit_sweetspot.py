...
from helpers import calc_flux_noise, f_scale
...
A_flux1_vals = np.linspace(A_flux1_min, A_flux1_max, 10) # x axis
A_flux2_vals = np.linspace(A_flux2_min, A_flux2_max, 10) # y axis
...
# Plot the results
# axes[0].imshow(avg_f_map, extent=[A_flux1_min, A_flux1_max, A_flux2_min, A_flux2_max], origin='lower', aspect='auto', cmap='viridis')
# axes[0].imshow(avg_f_map, cmap='viridis', origin='lower')
...
axes[1].scatter(range(len(flux_noise_list)), flux_noise_list)
