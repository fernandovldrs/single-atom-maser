...
from helpers import calc_flux_noise, calculate_geff, f_scale
...
for flux_theta in flux_theta_list:
    ...
    A_flux1_vals = np.linspace(A_flux1_min, A_flux1_max, 20) # x axis
    A_flux2_vals = np.linspace(A_flux2_min, A_flux2_max, 20) # y axis
